...
parser.add_argument('-sc', '--show_charts', action='store_true',
                    required=False, help='Shows the charts of position and orientation in real time')
parser.add_argument('-sg', '--show_gui', action='store_true', default=True,
                    required=False, help='Shows the GUI to reach the desired pose of the ArUco marker')
...
def main():
	...
	with np.load(r'C:\Biorobotics\Dissertation\visual servo control\camera calibration\camera_matrix.npz') as X:
